...
call mvn install:install-file -DgroupId=org.w3c.ddr.simple -DartifactId=DDR-Simple-API -Dversion=2008-06-02 -Dpackaging=jar -Dfile=w3c.jar -DgeneratePom=true -DcreateChecksum=true
